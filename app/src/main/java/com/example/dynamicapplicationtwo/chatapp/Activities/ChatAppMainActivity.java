package com.example.dynamicapplicationtwo.chatapp.Activities;
...
import com.example.dynamicapplicationtwo.chatapp.Adapters.RecentConversionsAdapter;
import com.example.dynamicapplicationtwo.chatapp.Models.ChatMessage;
import com.example.dynamicapplicationtwo.chatapp.Models.User;
import com.example.dynamicapplicationtwo.chatapp.Utitlities.Constants;
import com.example.dynamicapplicationtwo.chatapp.Utitlities.PreferenceManager;
import com.example.dynamicapplicationtwo.chatapp.listeners.ConversionListener;
import com.example.dynamicapplicationtwo.MainActivity;
import com.example.dynamicapplicationtwo.databinding.ActivityChatAppMainBinding;
...
public class ChatAppMainActivity extends BaseActivity implements ConversionListener {

    private ActivityChatAppMainBinding binding;
    ...
    private void updateToken(String token) {
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token) ///////
                .addOnFailureListener(e -> showToast("Unable to update taken"));
    ...
    public void onConversionClicked(User user) {
        Intent intent = new Intent(getApplicationContext(), ChatAppChatActivity.class);
